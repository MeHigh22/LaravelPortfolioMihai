            ...
            <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-links">
                            <a href="{{asset('/img/portfolio/portfolio-4.jpg')}}" data-gall="portfolioGallery" class="venobox"
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-links">
                            <a href="{{asset('/img/portfolio/portfolio-5.jpg')}}" data-gall="portfolioGallery" class="venobox"
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-links">
                            <a href="{{asset('/img/portfolio/portfolio-6.jpg')}}" data-gall="portfolioGallery" class="venobox"
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-links">
                            <a href="{{asset('/img/portfolio/portfolio-7.jpg')}}" data-gall="portfolioGallery" class="venobox"
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-links">
                            <a href="{{asset('/img/portfolio/portfolio-8.jpg')}}" data-gall="portfolioGallery" class="venobox"
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-links">
                            <a href="{{asset('/img/portfolio/portfolio-9.jpg')}}" data-gall="portfolioGallery" class="venobox"
                                title="Web 3"><i class="bx bx-plus"></i></a>
                            <a href="" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
